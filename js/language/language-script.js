const data = {
  ...
  content: {
    myanmar: {
      vision: 'အနာဂတ်',
      visionContent: 'မြန်မာနိုင်ငံ၏ ရေရှည်တည်တံ့ခိုင်မြဲသော အနာဂတ်တွင် RC နှင့် Steel Structure ဆောက်လုပ်ရေးတို့တွင်အထွတ်အထိပ်ခေါင်းဆောင်တစ်ဦးဖြစ်လာစေရန်',
      mission: 'ကျွန်ုပ်တို့၏တာဝန်',
      missionContent: [
        'ကျွန်ုပ်တို့ ၏ ဝန်ဆောင်မှုများနှင့် ထုတ်ကုန်များမှတစ်ဆင့် ဖောက်သည်များ၏လိုအပ်ချက်များအတွက်အကောင်းဆုံး အဖြေပေးအပ်ရန် ကတိပြုပါသည်။',
        'ကျွန်ုပ်တို့အဖွဲ့အစည်းနှင့်အစဉ်အားပေးသူ ဖောက်သည်များ၊ မိတ်ဆွေသစ်၊ မိတ်ဆွေဟောင်းများ၊လက်တွဲလုပ်ကိုင်လာကြသော မိတ်ဖက်ကုမ္ပဏီများ ပူးပေါင်း၍ ရေရှည်တည်တံ့ခိုင်မြဲသော အနာဂတ်ကိုတည်ဆောက်ရန်မှာ ကျွန်ုပ်တို့ တာဝန်တရပ်သာဖြစ်သည်။'
      ],
      ourStory: 'ကျွန်ုပ်​တို့အကြာင်း',
      ourStoryContent: [
        'Power Seven Construction ကို ဖေဖော်ဝါရီလ ၂၀၁၀ ခုနှစ်တွင် Founder ဖြစ်သူ ဦးဆန်နီမှမန္တလေးမြို့တွင်စတင်တည်ထောင်ခဲ့ပါသည်။',
        `စတင်တည်ထောင်ချိန်မှစ၍ အစိုးရငှာန
        မြောက်မြားစွာဖြင့် လက်တွဲလုပ်ကိုင်ခဲ့ရာ ယခု ၂၀၂၂`,
        ` ခုနှစ်အထိ မန္တလေးတိုင်း၊မကွေးတိုငး၊ရှမ်းပြည်နယ် နှင့် ချင်းပြည်နယ်အစရှိသော
        ပြည်နယ်နှင့်တိုင်းအသီးသီးတွင် စီမံကိန်း`,
        `(၁၀၀)ကျော်ခန့် ပြီးမြောက်လွှဲအပ်နိုင်ခဲ့ပြီဖြစ်ပါသည်။`,
        `       ကုန်ထုပ်လုပ်မှု Manufacturing Company ကိုမှု ၂၀၁၇ နိုဝင်ဘာတွင် တည်ထောင်ခဲ့ပြီး`,
        `4 Angle, C-Purlin ,Deck-Sheet အစရှိသည့်သံပြားပုံဖော်ခြင်း (roll-farming) အားစတင်လုပ်ဆောင်ခဲ့ပါသည်။`,
        ` တစ်လထုတ်လုပ်မှုစွမ်းရည်မှာ 1500-2000 MT ဖြစ်ပြီး ယခုအခါ မြန်မာနိုင်ငံအထက်ပိုင်းတွင်
    ...
    english: {
      ...
      mission: 'Our Mission',
      missionContent: [
        'Committed to deliver the best solution to our customers through our services and products.',
        'Building long-term partnership with our customers, supplier, team while creating sustainable future.'
      ],
      ourStory: 'Our Story',
      ourStoryContent: [
        `Founded By U Sanni in February 2010, in Mandalay.`,
        `Partnership with government’s`,
        ` construction projects and till now 2022 in Mandalay,Magway,Shan state and Chin states.`,
        ` Founded : February 2010`,
        ` Manufacturing`,
        ` Established : November 2017`,
        ` Roll Forming : 4-Angle Roofing`,
...
function changeLanguage(language) {
  ...
  const visionContent = document.getElementsByClassName('vision-content');
  const mission = document.getElementsByClassName('mission');
  const missionContent = document.getElementsByClassName('mission-content');
  const ourStory = document.getElementsByClassName('our-story');
  const ourStoryContent = document.getElementsByClassName('our-story-content');
  ...
  if (language === 'myanmar') {
    ...
    vision[0].textContent = data.content.myanmar.vision;
    visionContent[0].textContent = data.content.myanmar.visionContent;
    mission[0].textContent = data.content.myanmar.mission;
    for (let index = 0; index < missionContent.length; index++) {
      missionContent[index].textContent = data.content.myanmar.missionContent[index];
    }
    ourStory[0].textContent = data.content.myanmar.ourStory;
  ...
  if (language === 'english') {
    ...
    vision[0].textContent = data.content.english.vision;
    visionContent[0].textContent = data.content.english.visionContent;
    mission[0].textContent = data.content.english.mission;
    for (let index = 0; index < missionContent.length; index++) {
      missionContent[index].textContent = data.content.english.missionContent[index];
    }
    ourStory[0].textContent = data.content.english.ourStory;
    for (let index = 0; index < ourStoryContent.length; index++) {
